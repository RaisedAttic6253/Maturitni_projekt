...
<div class="row mb-4">
    <div class="col-12 text-center">
        <h1 class="mb-4 fw-bold text-warning"><i class="fa-solid fa-gauge-high"></i> Atmosférický tlak</h1>
    </div>
</div>

<div class="card shadow-sm mt-4 border-warning bg-black">
    <div class="card-header bg-warning d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3 gap-3">
    ...
    <div class="card-body p-0" style="background-color: #1d1d1d;">
        <canvas id="tlakGraf" style="min-height: 350px;"></canvas>
    </div>
</div>

<div class="row justify-content-center mt-4"> 
    <div class="col-md-12">
        <div class="card bg-dark text-light mb-3 text-center border-warning">
            <div class="card-body">
                <h6 id="titulekPrumer" class="text-uppercase fw-bold text-warning" style="letter-spacing: 1px;">Průměr (1h)</h6>
...
<style>
    ...
    .btn-group .btn-dark:hover, .btn-group .btn-dark.active { background-color: #d39e00 !important; border-color: #d39e00 !important; color: #ffffff !important; }
...
<script>
    ...
    const ctx = document.getElementById('tlakGraf').getContext('2d');
    ...
    function nactiData(obdobi, tlacitko = null) {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                chart.data.datasets[0].label = `Tlak (Poslední hodnota: ${posledniHodnota} <?= $jednotka ?>)`;
                chart.update();
